...
#ax.plot(xaxis, accLst[0], label=r'HighPassFilter$\times3$')
#ax.plot(xaxis, accLst[1], label=r'HighPassFilter$\times1$')
#ax.plot(xaxis, accLst[2], label=r'HighPassFilter$\times0$')

ax.plot(xaxis, lossLst[0], label=r'HighPassFilter$\times3$')
ax.plot(xaxis, lossLst[1], label=r'HighPassFilter$\times1$')
ax.plot(xaxis, lossLst[2], label=r'HighPassFilter$\times0$')
...
fig.savefig("hpf-train-loss.eps", bbox_inches='tight')
#fig.savefig("hpf-validation-acc.eps", bbox_inches='tight')
plt.show()