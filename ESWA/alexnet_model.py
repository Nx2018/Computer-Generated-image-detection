...
class alexnet(object):
    def __init__(self, x, keep_prob, num_classes, skip_layer, in_size=(227,227), weights_path = 'DEFAULT'):
        """
        Inputs:
    ...
    def create(self):
        # for padding='SAME'
        #    out_h = ceil(float(in_h)/float(strides_h))
        # for padding='VALID'
        #    out_h = ceil(float(in_h-filter_h+1)/float(strides_h))
